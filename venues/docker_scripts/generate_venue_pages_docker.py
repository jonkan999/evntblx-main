...
template_dir = os.path.join(base_dir, "venues/python")
...
seed_file_path = os.path.join(base_dir, "venues/python/venue_priority_seed.json")
...
for venue in ordered_venues:
    ...
    images_folder = os.path.join(base_dir, "venues/img")
...
output_path = os.path.join(base_dir, "festlokaler-stockholm.html")
